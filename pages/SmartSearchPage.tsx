...
import ReactMarkdown from 'react-markdown'; // لضمان عرض الردود المنسقة بشكل صحيح
...
const SmartSearchPage: React.FC = () => {
  ...
  const SCHOOL_LOGO = "/school-logo.png"; // استخدام شعارك المفرغ الجديد
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      setIsLoading(true); // تأخير بسيط لإظهار الأنيميشن
        ...
        {isLoading && (
          <div className="flex items-center gap-4 animate-pulse">
            <div className="w-10 h-10 rounded-full bg-white border border-green-100 flex items-center justify-center">
                <img src={SCHOOL_LOGO} alt="Thinking" className="w-6 h-6 object-contain opacity-40" />
            </div>
