...
const FEATURED_BOOKS = [
    ...
    { id: 8, titleAr: "محمد بن زايد والتعليم", authorAr: "مركز الإمارات للدراسات والبحوث الاستراتيجية", publisherAr: "مركز الإمارات للدراسات والبحوث الاستراتيجية", titleEn: "Mohamed bin Zayed and Education", authorEn: "ECSSR", publisherEn: "ECSSR", cover: "https://www.albayan.ae/assets/archives/images/2018/04/25/3247420.jpg" },
                ...
                <div className="w-full flex flex-col lg:flex-row gap-10 items-center justify-center">
                    ...
                    <div className="lg:order-2 flex flex-col items-center justify-center relative z-20 max-w-sm w-full">
                        <div onClick={handleMascotInteraction} className={`relative cursor-pointer transition-transform duration-300 w-full flex justify-center items-center ${isMascotClicked ? 'scale-95' : 'hover:scale-105'}`}>
                            ...
                            <img src="/school-logo.png" alt="" className="absolute inset-0 m-auto w-[80%] h-[80%] object-contain opacity-10 dark:opacity-20 dark:brightness-0 dark:invert z-0 pointer-events-none" />
