      ...
      <style>{`
        ...
        * { font-family: 'Cairo', sans-serif !important; }
        ...
        .animate-text-reveal-delayed { 
          animation: reveal-text 1.2s cubic-bezier(0.77, 0, 0.175, 1) 0.3s forwards; 
          clip-path: polygon(0 100%, 100% 100%, 100% 100%, 0 100%); /* إخفاء مبدئي */
        }
