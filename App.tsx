...
// -------- 2. هيدر EFIPS الفخم الرشيق (Mobile Scroll & Above Hints) --------
const Header: React.FC = () => {
  ...
  const links = [
    ...
    { path: '/map', label: locale === 'en' ? 'Map' : 'خريطة المكتبة', icon: '🗺️', hint: locale === 'en' ? 'Map View' : 'موقع الأرفف', color: 'bg-red-600' },
