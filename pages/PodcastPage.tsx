...
const translations = {
  ar: {
    ...
    inst1: "يجب الالتزام بالكتب الموجودة حصرياً داخل المكتبة الرقمية (العربية أو الإنجليزية) الخاصة بالمدرسة أو الموجودة داخل المكتبة الفعلية.",
  ...
  en: {
    ...
    inst1: "You must use only the books available within the school’s digital library (Arabic or English) or the school library.",
