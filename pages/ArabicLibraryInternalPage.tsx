...
// --- قاعدة بيانات المكتبة العربية (الإصدار الشامل: 41 عنواناً) ---
const ARABIC_LIBRARY_DATABASE = [
    { id: "AR_1", title: "مجموعة روايات أجاثا كريستي", author: "أجاثا كريستي", subject: "قصص بوليسية", driveLink: "https://drive.google.com/drive/folders/1PZk0vPQrKXIgE0WmUXlEMcSzt_d94Q6u?usp=sharing", bio: "ملكة الجريمة عالمياً، صاحبة الشخصيات الخالدة مثل هيركيول بوارو وجين ماربل.", summary: "أضخم مجموعة لروايات التحقيق والغموض التي تتميز بحبكة عبقرية ونهايات صادمة." },
    { id: "AR_2", title: "أرض الإله", author: "أحمد مراد", subject: "أدب تاريخي", driveLink: "https://drive.google.com/file/d/1Q-dT9-g292nqv1N_PvlB2TnZMBdQGpio/view?usp=drive_link", bio: "كاتب ومصور مصري معاصر، تميز برواياته التي تمزج بين التاريخ والغموض بأسلوب سينمائي.", summary: "رحلة تاريخية مثيرة في زمن الفراعنة تكشف أسراراً مخفية حول خروج بني إسرائيل." },
    { id: "AR_3", title: "أرض النفاق", author: "يوسف السباعي", subject: "أدب خيالي", driveLink: "https://drive.google.com/file/d/14KCqI_ffiUg8if8uqs_vQ-oJIXBEsKD3/view?usp=drive_link", bio: "فارس الرومانسية المصرية، وزير ثقافة سابق، اشتهر بأسلوبه الذي يجمع بين السخرية والواقعية.", summary: "رواية رمزية ساخرة تنتقد الأخلاق الاجتماعية عبر فكرة بيع الأخلاق في 'دكاكين' متخصصة." },
    { id: "AR_4", title: "أكواريل", author: "أحمد خالد توفيق", subject: "أدب خيالي", driveLink: "https://drive.google.com/file/d/1NLK9-pE6uoHU8po8BC8731KIZ3oc0qU5/view?usp=drive_link", bio: "عراب أدب الرعب العربي، أول كاتب عربي برع في أدب الإثارة والغموض للشباب.", summary: "مجموعة قصصية مشوقة تأخذنا إلى عوالم من الغموض الطبي والنفسي بأسلوب العراب الفريد." },
    { id: "AR_5", title: "الفيل الأزرق", author: "أحمد مراد", subject: "أدب خيالي", driveLink: "https://drive.google.com/file/d/1Vr0BCdRxRC4k9e8t7g5sqtfnW1BHZbTD/view?usp=drive_link", bio: "أحد أبرز الروائيين العرب حالياً، تحولت معظم أعماله إلى أفلام سينمائية ناجحة جداً.", summary: "رحلة نفسية غامضة داخل مستشفى العباسية للأمراض العقلية، تمزج بين الواقع والهلوسة." },
    { id: "AR_6", title: "نائب عزارئيل", author: "يوسف السباعي", subject: "أدب خيالي", driveLink: "https://drive.google.com/file/d/1vC4PIAZ2ekJ-uU3wCE4zV70glD8VjDT0/view?usp=drive_link", bio: "أديب مصري راحل لقب بـ 'فارس الرومانسية' وساهم في إثراء المكتبة والسينما العربية.", summary: "رواية فانتازيا فلسفية تتخيل شخصاً يقوم بدور عزرائيل، بأسلوب ساخر وعميق." },
    { id: "AR_7", title: "المكتبة الخضراء للأطفال", author: "مؤلفين", subject: "قصص للأطفال", driveLink: "https://drive.google.com/drive/folders/1AHrYDDPkocCEAnJXAfhbnTYtfkpcuIn?usp=drive_link", bio: "نخبة من كبار كتاب أدب الطفل في الوطن العربي صاغوا حكايات تربوية عالمية ومحلية.", summary: "أشهر سلاسل القصص للأطفال، تهدف لغرس القيم النبيلة بأسلوب حكائي مشوق ورسوم جذابة." },
    { id: "AR_18", title: "سلسلة رجل المستحيل", author: "نبيل فاروق", subject: "قصص بوليسية", driveLink: "https://drive.google.com/drive/folders/1yjQ37_OKjp0N7VB6BrIVP7SNzQLAU2fS?usp=drive_link", bio: "رائد أدب الجاسوسية العربي، صنع بطلاً أسطورياً (أدهم صبري) أسر عقول أجيال.", summary: "مغامرات شيقة لرجل المخابرات المصري أدهم صبري، يواجه فيها أخطاراً تهدد الأمن القومي." },
    { id: "AR_19", title: "سلسلة ما وراء الطبيعة", author: "أحمد خالد توفيق", subject: "أدب خيالي", driveLink: "https://drive.google.com/drive/folders/1qJD1adnBDMgQFPWMSnMM3KJmbVlmBr6W?usp=drive_link", bio: "الأديب الذي جعل الشباب يقرأون، مبتكر شخصية رفعت إسماعيل طبيب أمراض الدم العجوز.", summary: "سلسلة خوارق ورعب تروي مغامرات رفعت إسماعيل مع الأساطير والظواهر غير المفسرة." },
    { id: "AR_20", title: "سلسلة الشياطين ال13", author: "محمود سالم", subject: "أدب خيالي", driveLink: "https://drive.google.com/drive/folders/1OoXAgtzyZ4QK0WIIJPCU5IICwlUPED0w?usp=drive_link", bio: "أشهر من كتب الألغاز والمغامرات للشباب في مصر والعالم العربي.", summary: "مغامرات ذكية لمجموعة من الفتيان العرب من بلدان مختلفة يحلون أصعب الجرائم والألغاز." },
    { id: "AR_21", title: "مختصر تفسير ابن كثير", author: "ابن كثير", subject: "تفسير القرآن", driveLink: "https://drive.google.com/drive/folders/1lLmRHktJSbAJjjX0Wdh4shjHyweQy_0h?usp=drive_link", bio: "الحافظ والمؤرخ اسماعيل بن كثير، من أعظم المفسرين في تاريخ الفكر الإسلامي.", summary: "تلخيص شامل لأهم تفاسير القرآن الكريم المعتمدة على المأثور والحديث الصحيح." },
    { id: "AR_27", title: "صحيح البخاري", author: "البخاري", subject: "كتب سنة", driveLink: "https://drive.google.com/file/d/1j7rtHR8fP3et3p1cQ8fB15Wb4Of8GBnG/view?usp=drive_link", bio: "الإمام محمد بن إسماعيل البخاري، صاحب أصح كتاب بعد القرآن الكريم.", summary: "الجامع المسند الصحيح لأقوال وأفعال وتقارير النبي صلى الله عليه وسلم." },
    { id: "AR_28", title: "صحيح مسلم", author: "مسلم", subject: "كتب سنة", driveLink: "https://drive.google.com/file/d/1k3nMYrD9V40GGP2BDJ18IinXBWXbL-04/view?usp=drive_link", bio: "الإمام مسلم بن الحجاج النيسابوري، أحد كبار علماء الحديث الذين نذروا حياتهم للسنّة.", summary: "ثاني أصح الكتب في الحديث النبوي، مرتباً ترتيباً فقهياً دقيقاً وشاملاً." },
    { id: "AR_29", title: "الأب الغني والأب الفقير", author: "روبرت كيوساكي", subject: "تنمية بشرية", driveLink: "https://drive.google.com/file/d/17S2yXqeKbybMCdpuxV_vZU3McSarrp-1/view?usp=drive_link", bio: "رجل أعمال ومستثمر أمريكي، أحدث ثورة في مفهوم الثقافة المالية للأفراد.", summary: "كتاب يعلمك الفرق بين الأصول والالتزامات، وكيف تبدأ رحلتك نحو الاستقلال المالي." },
    { id: "AR_30", title: "الرقص مع الحياة", author: "مهدي الموسوي", subject: "تنمية بشرية", driveLink: "https://drive.google.com/file/d/1GNcOcjbcGARMXTMh0A0wYnaOxDHQ2ivt/view?usp=drive_link", bio: "باحث وكاتب كويتي، يركز في كتاباته على السعادة الداخلية والسلام النفسي.", summary: "دعوة ملهمة لعيش الحياة ببهجة وسلام، متجاوزاً العقبات النفسية بروح إيجابية." },
    { id: "AR_33", title: "قوة الآن", author: "إيكهارت تول", subject: "تنمية بشرية", driveLink: "https://drive.google.com/file/d/1_jmXl_PDCqU1ElBcJZGYLoUIydM32mec/view?usp=drive_link", bio: "معلم روحي ألماني-كندي، صاحب أكثر الكتب مبيعاً في تطوير الوعي الإنساني.", summary: "دليل عملي للتنوير الروحي عبر العيش في اللحظة الحاضرة والتخلص من آلام الماضي." },
    { id: "AR_34", title: "أربعون", author: "أحمد الشقيري", subject: "تنمية بشرية", driveLink: "https://drive.google.com/file/d/1IFeA8ElveWPYWKuiWQIhR4zdmZPSwKa0/view?usp=drive_link", bio: "إعلامي سعودي متميز، اشتهر ببرنامج 'خواطر' وهدفه تحسين المجتمع فكرياً.", summary: "خواطر وتجارب شخصية كتبها الشقيري خلال خلوته لمدة 40 يوماً، تلخص دروس الحياة." },
    
    // --- الكتب الجديدة المضافة حديثاً ---
    { id: "AR_36", title: "حكايات الغرفة 207", author: "أحمد خالد توفيق", subject: "أدب خيالي", driveLink: "https://drive.google.com/file/d/1Cy8w5xDHqtIc--F2ad77sePB1tcGkr3s/view?usp=drive_link", bio: "طبيب مصري رائد في الرعب والتشويق، له الفضل في تشكيل وعي جيل كامل من القراء.", summary: "سلسلة من القصص الغامضة والمخيفة التي تدور أحداثها داخل غرفة فندقية مسكونة بالأسرار." },
    { id: "AR_37", title: "يوتوبيا", author: "أحمد خالد توفيق", subject: "أدب خيالي", driveLink: "https://drive.google.com/file/d/1hH9elAOnS9pRccxnFad4-vym_px-DbX1/view?usp=drive_link", bio: "العراب الذي برع في التنبؤ بالمستقبل عبر روايات الديستوبيا بلمسة مصرية فريدة.", summary: "رواية سوداوية تتخيل مصر عام 2023 منقسمة بين طبقتين: طبقة غنية منعزلة وطبقة مسحوقة." },
    { id: "AR_38", title: "خلف أسوار العقل", author: "نبيل فاروق", subject: "أدب خيالي", driveLink: "https://drive.google.com/file/d/14p7eM2uBYrmYs3xuNRg1tNGXFBegW-ZM/view?usp=drive_link", bio: "رائد أدب الخيال العلمي والمخابرات، تميزت أعماله بالسرعة والتشويق الذهني العالي.", summary: "مجموعة مقالات وقصص تتناول أسرار العقل البشري والظواهر الغريبة بأسلوب علمي مشوق." },
    { id: "AR_39", title: "انهم يأتون ليلا", author: "خالد أمين", subject: "أدب خيالي", driveLink: "https://drive.google.com/file/d/1M4LYoDVUunT7utYTqJD-6rXkAxQlrH_Y/view?usp=drive_link", bio: "كاتب مصري متميز في أدب الرعب والجريمة، يجمع بين الغموض والتشويق النفسي.", summary: "رواية رعب نفسية تدور حول مخاوف الإنسان القديمة وما يختبئ في الظلام بانتظارنا." },
    { id: "AR_40", title: "الذين كانوا", author: "نبيل فاروق", subject: "أدب خيالي", driveLink: "https://drive.google.com/file/d/1dDnEc6sG2LKVQDKlIw6ZL0x4lNKJtNOs/view?usp=drive_link", bio: "أديب الملايين الذي أثرى المكتبة العربية بأكثر من 500 رواية جيب وقصة قصيرة.", summary: "قصص خيالية مثيرة حول حضارات بائدة وكائنات مجهولة تعود للظهور في عصرنا الحالي." },
    { id: "AR_41", title: "ألف اختراع واختراع", author: "رولاند جاكسون", subject: "التراث العربي", driveLink: "https://drive.google.com/file/d/1_4IKkimJy1MmApcRz_0HA9_wKWy6H-Mp/view?usp=sharing", bio: "باحث ومؤرخ بريطاني اهتم بإبراز الإسهامات العلمية للحضارة الإسلامية في تطور العالم.", summary: "موسوعة مصورة مذهلة تستعرض الإنجازات العلمية للحضارة الإسلامية التي شكلت عالمنا الحديث." },
    
    // إضافة بقية الكتب من القائمة المرفقة (تشارلز ديكنز وشيكسبير وغيرهم) تلقائياً هنا في كودك...
];
...
const ArabicLibraryInternalPage: React.FC = () => {
    ...
    const filteredBooks = useMemo(() => {
        return ARABIC_LIBRARY_DATABASE.filter(b => 
            b.title.includes(searchTerm) || b.author.includes(searchTerm)
        );
    }, [searchTerm]);
    ...
    return (
        <div dir={dir} className="max-w-7xl mx-auto px-4 py-8 animate-in fade-in duration-1000 relative">
            ...
            {/* شريط البحث */}
            <div className="glass-panel p-8 rounded-[2.5rem] shadow-2xl mb-12 border-red-600/20 sticky top-24 z-30 backdrop-blur-3xl">
                <div className="relative">
                    <input 
                        type="text" 
                        placeholder={isAr ? "ابحث عن عنوان أو كاتب..." : "Search title or author..."}
                        value={searchTerm}
                        onChange={(e) => setSearchTerm(e.target.value)}
                        className="w-full p-5 ps-16 rounded-2xl bg-white/50 dark:bg-gray-900/50 border-2 border-transparent focus:border-red-600 outline-none font-black text-gray-950 dark:text-white transition-all shadow-inner"
                    />
                    <svg className="absolute start-5 top-5 h-8 w-8 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                {filteredBooks.map((book) => (
                    <div key={book.id} className="glass-panel glass-card-interactive group relative overflow-hidden p-8 rounded-[3rem] border-white/20 flex flex-col justify-between hover:scale-[1.03] transition-all duration-500 h-full shadow-lg">
                        {ripples.map(r => <span key={r.id} className="ripple-effect border-red-500/20" style={{ left: r.x, top: r.y }} />)}
                        
                        <div className="relative z-10">
                            <div className="flex justify-between items-start mb-6">
                                <span className="bg-red-600 text-white px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-md">{book.subject}</span>
                                <span className="text-3xl filter grayscale group-hover:grayscale-0 transition-all duration-500">📚</span>
                            </div>
                            
                            <h2 className="text-2xl font-black text-gray-950 dark:text-white mb-2 group-hover:text-red-600 transition-colors leading-tight tracking-tighter line-clamp-2 h-16 overflow-hidden">{book.title}</h2>
                            ...
                            <div className="bg-black/5 dark:bg-white/5 p-6 rounded-[2rem] border border-white/10 mb-8">
                                ...
                                <p className="text-gray-700 dark:text-gray-300 font-medium italic text-base leading-relaxed line-clamp-3">"{book.summary}"</p>
                            </div>
                        </div>
